            ...
            <div className="container" style={{ maxWidth: '480px' }}>
                <div style={{ background: '#fff0e5', padding: '50px 40px', borderRadius: '40px', border: '1px solid #ebcfb9', textAlign: 'center', boxShadow: '0 30px 60px rgba(38, 26, 19, 0.08)' }}>
                    ...
                    <div style={{ marginBottom: '40px' }}>
                        ...
                        <h2 style={{ color: '#261a13', margin: '0 0 10px 0', fontSize: '32px', fontWeight: '900' }}>Welcome Home</h2>
                        <p style={{ color: '#8d7a6e', fontSize: '16px', margin: 0 }}>Experience effortless luxury with Arbanda</p>
                    </div>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '20px', marginBottom: '30px' }}>
                        ...
                        <span style={{ color: '#b08d74', fontSize: '12px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px' }}>or use account</span>
                        <div style={{ flex: 1, height: '1px', background: '#ebcfb9' }}></div>
                    </div>
                        ...
                        <form onSubmit={handleEmailLogin} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                            ...
                            <div style={{ textAlign: 'left' }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
                                    <label style={{ color: '#b08d74', fontSize: '13px', fontWeight: '800', textTransform: 'uppercase' }}>Password</label>
                                    <Link to="/forgot-password" style={{ color: '#8d7a6e', fontSize: '11px', textDecoration: 'none', fontWeight: '800' }}>FORGOT?</Link>
                                </div>
                                <input
                                    type="password"
                                    required
                        ...
                        <form onSubmit={showOtpField ? handleVerifyOtp : handleSendOtp} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                            ...
                            {showOtpField && (
                                <div style={{ textAlign: 'left', animation: 'fadeIn 0.3s ease' }}>
                                    <label style={{ display: 'block', color: '#b08d74', marginBottom: '10px', fontSize: '13px', fontWeight: '800', textTransform: 'uppercase' }}>6-Digit OTP Code</label>
                                    <input
                                        type="text"
                                        required
                                        value={phoneData.otp}
                            ...
                            <button
                                ...
                                style={{ width: '100%', padding: '20px', marginTop: '15px', borderRadius: '40px', fontSize: '15px', fontWeight: '900', letterSpacing: '1px' }}
                            >
                                {loading ? 'PROCESSING...' : (showOtpField ? 'VERIFY & LOG IN' : 'SEND OTP CODE')}
                            </button>
                    ...
                    <p style={{ color: '#8d7a6e', marginTop: '40px', fontSize: '15px', fontWeight: '600' }}>
                        New to Arbanda? <Link to="/register" style={{ color: '#261a13', textDecoration: 'none', fontWeight: '800', borderBottom: '2px solid #ebcfb9', paddingBottom: '2px' }}>Request Invitation</Link>
                    </p>
                </div>
            </div>
        </div>
